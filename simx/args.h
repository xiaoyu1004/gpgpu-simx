...
template <typename T>
class CommandLineArgSetter : public CommandLineArg {
 public:
    CommandLineArgSetter(std::string s, std::string l, const char* ht, T& x)
        : CommandLineArg(s, l, ht), arg_(x) {}

    CommandLineArgSetter(std::string l, const char* ht, T& x) : CommandLineArg(l, ht), arg_(x) {}
...
class CommandLineArgFlag : public CommandLineArg {
 public:
    ...
    CommandLineArgFlag(std::string l, const char* ht, bool& x) : CommandLineArg(l, ht), arg_(x) {
        arg_ = false;
    }
